...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train", type=str, default="data/Train.csv",
        help="Path to training CSV file (default: data/Train.csv)"
    )
    parser.add_argument(
        "--test", type=str, default="data/test.csv",
        help="Path to test CSV file (default: data/test.csv)"
    )
